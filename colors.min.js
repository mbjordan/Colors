/* JS Colors Library v0.2 * http://matthewbjordan.me/colors * Copyright 2011 Matthew B. Jordan * Licensed under Creative Commons http://creativecommons.org/licenses/by-sa/3.0/ */
...
a:"Invalid Color Name"}},name2hsv:function(a){a=this.name2hex(a);return/^[a-fA-F0-9#]{7}$/.test(a)?this.hex2hsv(a):{H:"Invalid Color Name",S:"Invalid Color Name",V:"Invalid Color Name",HSV:"Invalid Color Name",a:"Invalid Color Name"}},complement:function(a,b){if("string"==typeof a&&"hex"==b)return a=a.replace("#",""),"#"+this.rgb2hex(255-this.hex2rgb(a.substr(0,2)))+this.rgb2hex(255-this.hex2rgb(a.substr(2,2)))+this.rgb2hex(255-this.hex2rgb(a.substr(4,2)));if("rgb"==b)return{R:255-a[0],G:255-a[1],
B:255-a[2],RGB:255-a[0]+" "+(255-a[1])+" "+(255-a[2]),a:[255-a[0],255-a[1],255-a[2]]}},rand:function(a){if("hex"==a||void 0==a){for(var a="",b=0;6>b;b++)var c=Math.floor(16*Math.random()),a=a+"0123456789abcdef".substring(c,c+1);return"#"+a}if("rgb"==a)return R=Math.floor(-254*Math.random()+255),G=Math.floor(-254*Math.random()+255),B=Math.floor(-254*Math.random()+255),{R:R,G:G,B:B,RGB:R+" "+G+" "+B,a:[R,G,B]}}};