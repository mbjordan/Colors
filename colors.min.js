...
teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"}[a];return void 0===a?"Invalid Color Name":a},name2rgb:function(a){a=this.name2hex(a);return/^[a-fA-F0-9#]{7}$/.test(a)?this.hex2rgb(a):h.render(["Invalid Color Name","Invalid Color Name","Invalid Color Name"],"rgb")},name2hsv:function(a){a=this.name2hex(a);return/^[a-fA-F0-9#]{7}$/.test(a)?this.hex2hsv(a):h.render(["Invalid Color Name",
"Invalid Color Name","Invalid Color Name"],"hsv")},complement:function(a,b,d){var c;if("string"==typeof a&&/(#([A-Fa-f0-9]){3}(([A-Fa-f0-9]){3})?)/.test(a))return a=a.replace("#",""),b="#",6===a.length&&(b+=h.paddedHex(255-this.hex2rgb(a.substr(0,2))),b+=h.paddedHex(255-this.hex2rgb(a.substr(2,2))),b+=h.paddedHex(255-this.hex2rgb(a.substr(4,2)))),3===a.length&&(b+=h.paddedHex(255-this.hex2rgb(a.substr(0,1)+a.substr(0,1))),b+=h.paddedHex(255-this.hex2rgb(a.substr(1,1)+a.substr(1,1))),b+=h.paddedHex(255-
this.hex2rgb(a.substr(2,1)+a.substr(2,1)))),b;void 0!==a&&(void 0!==b&&void 0!==d)&&(c=[255-a,255-b,255-d]);"object"==typeof a&&(c=[255-a[0],255-a[1],255-a[2]]);return h.render(c,"rgb")},rand:function(a){if("hex"===a||void 0===a){a="";var b,d;for(d=0;6>d;d++)b=Math.floor(16*Math.random()),a+="0123456789abcdef".substring(b,b+1);return"#"+a}if("rgb"==a)return a=Math.floor(-254*Math.random()+255),b=Math.floor(-254*Math.random()+255),d=Math.floor(-254*Math.random()+255),h.render([a,b,d],"rgb")}}})(window);
